...
export default function Contact() 
{
  ...
  return (
    <div className="w-full flex flex-col justify-evenly items-center">
      <h1 className="text-sup-head text-theme font-bold font-main uppercase">Hi! there, <span className="text-black text-xl font-main-alt">Let get connected</span></h1>
      <hr className="w-[30%] border-theme rounded-xl my-[2rem]"/>
      <h1 className="text-heading underline mb-4">Find me </h1>
      <div className="text-black text-sup-tit flex flex-col justify-around items-start my-6">
