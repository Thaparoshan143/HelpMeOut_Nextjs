...
export default function Home() 
{
  ...
  return (
    <div className="flex flex-col items-center justify-evenly font-main w-full">
      <h1 className="text-sub-head md:text-heading text-theme font-bold my-10 underline uppercase font-main">Available Catergories</h1>
...
const CouldNotFind = () =>
{
  return (
    <div className="w-full px-2 text-center bg-theme flex flex-col justify-around items-center h-[15rem] pt-10 mt-[8rem] text-white">
      <h1><span className="text-sm md:text-sub-tit inline-block h-10 font-extrabold">Is Something Missing ? </span> Got any other resources you want to <a href={"/contact"} className="p-2 bg-white hover:font-bold text-theme rounded-md">recommend</a></h1>
