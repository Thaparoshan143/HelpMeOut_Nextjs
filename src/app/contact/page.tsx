  ...
  return (
    <div className="w-full text-2xl flex flex-col justify-evenly items-center">
      ...
      <div className="text-black text-xl flex flex-col justify-around items-start">
        <h1 className="text-3xl underline mb-2">Find me </h1>
      ...
      <hr className="w-[40%] border-theme border-[1.2px] rounded-xl my-[2rem]"/>
      ...
      <hr className="w-[20%] border-theme rounded-xl my-[2rem]"/>
    </div>
  );
}
