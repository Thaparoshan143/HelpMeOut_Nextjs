...
export default function Home() {
  return (
    <>
    <div className="flex flex-col flex-wrap justify-evenly items-center text-center min-h-[50vh] h-full w-full">
      <h1 className="text-theme  text-6xl md:text-8xl font-bold uppercase font-mono">Help Me Out</h1>
