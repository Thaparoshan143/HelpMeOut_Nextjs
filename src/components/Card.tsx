...
const Card = ({title, name, description, url} : any) => 
{
  return (
    <div className="p-2 m-2 shadow-sm border-[0.1rem] hover:border-theme-a hover:shadow-theme-alt inset-x-4 shadow-theme rounded-xl bg-[#eee] flex flex-col justify-evenly items-center relative min-w-[15rem] w-[20rem] min-h-[6rem]">
        <FaExternalLinkAlt className="absolute top-1 right-1 bg-theme text-white hover:scale-105 text-3xl p-[0.35rem] mx-2 rounded-md hover:cursor-pointer hover:bg-theme-alt transition-all duration-200 inline-block" onClick={url}/>
...
{
  return (
    <div className="p-2 bg-theme hover:shadow-xl min-w-[20rem] w-[20rem] min-h-[12rem] transition-all duration-200 rounded-md flex flex-col justify-evenly items-center opacity-80 hover:opacity-100">
